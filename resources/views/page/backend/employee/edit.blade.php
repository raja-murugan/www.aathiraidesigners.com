<div class="modal-dialog modal-dialog-centered modal-md">
   <div class="modal-content">
      ...
      <form autocomplete="off" method="POST"
                action="{{ route('employee.edit', ['unique_key' => $Employee_datas['unique_key']]) }}" enctype="multipart/form-data">
                @csrf
         ...
         <div class="row">
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Enter Employee Name" name="name" id="name" required value="{{ $Employee_datas['name'] }}">
                  </div>
               </div>
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                     <label>Phone Number<span class="text-danger">*</span></label>
                     <input type="text" class="form-control employee_phoneno" placeholder="Enter Employee Contact No" name="phone_number" id="phone_number" value="{{ $Employee_datas['phone_number'] }}" required>
                  </div>
               </div>
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                     <label>Address</label>
                     <input type="text" class="form-control" placeholder="Enter Employee Address" name="address" id="address" value="{{ $Employee_datas['address'] }}">
                  </div>
               </div>
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
               ...
               <div class="col-lg-12 col-md-12" hidden>
                  <div class="form-group">
                     <label>Photo</label>
                     <div class="col-sm-3">
                        <img src="{{ asset('assets/photo/' .$Employee_datas['photo']) }}" alt="" style="width: 200px !important; height: 150px !important; margin-right: 40px !important; margin-top: 25px !important;">
                     </div>
