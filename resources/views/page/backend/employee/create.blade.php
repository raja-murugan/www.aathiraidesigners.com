                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control employee_phoneno"
                                placeholder="Enter Employee Contact No" name="phone_number" id="phone_number" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Employee Email Address"
                                name="email" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
