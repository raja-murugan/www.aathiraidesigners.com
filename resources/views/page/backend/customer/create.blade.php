                           ...
                           <div class="row align-item-center">
                                 <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" value="" class="form-control" placeholder="Enter Customer Name" name="name" id="name" required>
                                    </div>
                                 </div>
                                 <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                       <label >Contact Number <span class="text-danger">*</span></label>
                                       <input type="text" value="" class="form-control customerphoneno" placeholder="Enter Contact Number" name="phone_number" id="phone_number"required>
                                    </div>
                                 </div>
                           </div>
                        </div>
                                          ...
                                          <div class="table-responsive no-pagination">
                                            <table class="table table-center table-hover">
                                                ...
                                                <tbody class="product_fields">
                                                    <tr>
                                                        <td>
                                                        <input type="hidden" id="customer_products_id" name="customer_products_id[]" />
                                                            <select
