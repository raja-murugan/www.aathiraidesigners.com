                    ...
                    <div class="list-btn">
                        <div style="display:flex;">
                            ...
                            <div class="page-btn">
                                <div style="display: flex;">
                                    <div style="display: flex">
                                        <div style="margin-right: 10px;"><input type="date" name="from_date" readonly
                            ...
                            @if (Auth::user()->role == 'Admin')
                                <form autocomplete="off" method="POST"
                                    action="{{ route('admin_attendance.admin_departmentwisefilter') }}">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            @if ($Attendance_datas['status'] == 'Present')
                                                <td><img src="{{ asset($Attendance_datas['checkin_photo']) }}"
                                                        alt=""
                                                        style="width: 70px !important; height: 70px !important;"></td>
