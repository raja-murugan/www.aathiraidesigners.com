    ...
    <div class="modal-content">
        ...
        <div class="modal-header border-0 pb-0">
            <div class="form-header modal-header-title text-start mb-0">
                <h6 class="mb-0" style="color:red;text-transform:uppercase;">Pay Balance</h6>
            </div>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                <span class="align-center" aria-hidden="true">&times;</span>
            </button>
        </div>
        <form autocomplete="off" method="POST" action="{{ route('billing.paybalance', ['id' => $Billing_datas['id']]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $Billing_datas['customer'] }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label>Phone Number <span class="text-danger">*</span></label>
                            <input type="text" class="form-control " value="{{ $Billing_datas['phone_number'] }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label>Grand Total</label>
                            <input type="text" class="form-control" name="pb_grand_total" id="pb_grand_total" value="{{ $Billing_datas['grand_total'] }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label>Total Paid Amount</label>
                            <input type="text" class="form-control" name="pb_totalpaidamount" id="pb_totalpaidamount" value="{{ $Billing_datas['total_paid_amount'] }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label>Total Balance Amount</label>
                            <input type="text" class="form-control" style="color:red;" name="pb_totalbalanceamount" id="pb_totalbalanceamount{{$Billing_datas['id']}}" value="{{ $Billing_datas['total_balance_amount'] }}" readonly>
                        </div>
                    </div>
                    ...
                    $(document).ready(function() {
                        $('.paybalance' + {{ $Billing_datas['id'] }}).each(function() {
                            $(this).on('click', function(e) {
                                ...
                                $(document).on("keyup", '#pb_paidamount' + {{ $Billing_datas['id'] }}, function() {
                                    var payable_amount = $(this).val();
                                    
                                    var balance_amount = $('#pb_totalbalanceamount' + {{ $Billing_datas['id'] }}).val();
                    ...
                    <div class="col-lg-4 col-md-4" >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control pb_paidamount" name="pb_paidamount" id="pb_paidamount{{$Billing_datas['id']}}" required>
                        </div>
                    </div>
                </div>
            </div>
